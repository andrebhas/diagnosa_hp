...
<div class="content">
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <h5 class="panel-title">Pertanyaan List</h5>
        ...
        <div class="panel-body"> 
            <div class="row">
                <div class="col-md-5 text-left">
                    <?php echo anchor(site_url('pertanyaan/create'), '<i class="fa fa-plus-square"></i> Tambah', 'class="btn btn-default btn-xs" data-popup="tooltip-custom" title="tambah data"'); ?>
				</div>
            ...
            ?>
                    <tr>
						...
						<td><?php echo $pertanyaan->id_jenis_kerusakan ?></td>
						<td><?php echo $pertanyaan->ya ?></td>
						<td><?php echo $pertanyaan->tidak ?></td>
						<td style="text-align:center" width="200px">
						<?php 
							echo anchor(site_url('pertanyaan/read/'.$pertanyaan->id),'Detail'); 
							echo ' | '; 
							echo anchor(site_url('pertanyaan/update/'.$pertanyaan->id),'Update'); 
							echo ' | '; 
							echo anchor(site_url('pertanyaan/delete/'.$pertanyaan->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
						?>
						</td>
					</tr>
            <?php
